...
from app.core.errors import invalid_request, password_change_required
from app.core.i18n import MessageKey
from app.core.middleware.rate_limit import trusted_client_ip
...
from app.core.security.tokens import issue_access_token, list_active_sessions
from app.db.redis import get_rate_limit_redis, get_redis
from app.dependencies.authentication import (
    SettingsDependency,
    get_authorization_context,
    require_permissions,
)
from app.dependencies.captcha import parse_captcha_create_request
...
from app.services.abuse_flow import IdentityAbuseFlow, build_identity_abuse_flow
